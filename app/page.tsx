      ...
      <div className="relative z-10 pointer-events-auto">
        ...
        <footer className="bg-slate-950/80 backdrop-blur-md border-t border-slate-900 py-10 px-4 text-center">
          <div className="flex justify-center gap-6 mb-6">
            ...
            <a href="https://wa.me/923039720693" target="_blank" rel="noreferrer" className="text-slate-300 hover:text-emerald-400 transition drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]" aria-label="Direct Chat via WhatsApp Connection Channel">
