      ...
      <div className="relative z-10 pointer-events-auto">
        ...
        <section id="contact" className="max-w-3xl mx-auto py-16 md:py-24 px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-sm md:text-base mt-2">
              Currently open for technical deep dives or custom engineering solutions. Reach out via the form or connect on{" "}
              <a href="https://www.linkedin.com/in/abdul-azeem-22b337416" target="_blank" rel="noreferrer" className="text-cyan-400 hover:underline font-medium">LinkedIn</a>.
            </p>
          </div>
        ...
        <footer className="bg-slate-950/40 backdrop-blur-sm border-t border-slate-900 py-10 px-4 text-center">
          <div className="flex justify-center gap-6 mb-6">
            ...
            <a href="https://www.linkedin.com/in/abdul-azeem-22b337416" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-blue-400 transition" aria-label="LinkedIn Profile Connection Lookup">
