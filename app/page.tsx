      ...
      <div className="relative z-10 pointer-events-auto">
        ...
        <footer className="bg-slate-950/40 backdrop-blur-sm border-t border-slate-900 py-10 px-4 text-center">
          <div className="flex justify-center gap-6 mb-6">
            ...
            <a href="https://linkedin.com/in/abdul-azeem-22b337416" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-sky-500 transition" aria-label="LinkedIn Professional Network Profile Lookup">
